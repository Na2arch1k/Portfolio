export const SITE = {
  ...
  role: "ClinicCard та цифрові системи для бізнесу",
  url: "https://nazariidev.com",
  locale: "uk_UA",
  description:
    "ClinicCard — система керування приватною клінікою. Також створюю сайти, чат-боти, CRM та автоматизації під реальні процеси бізнесу.",
