...
export function Hero() {
  ...
  return (
    <section ref={sectionRef} id="home" className="hero-stage relative h-[185svh] border-b border-white/10">
      <div className="sticky top-0 min-h-[100svh] overflow-hidden pt-28">
        ...
        <Container className="relative flex min-h-[calc(100svh-7rem)] flex-col pb-7">
          ...
          <m.div style={reduceMotion ? undefined : { y: titleY, opacity: titleOpacity }} className="relative z-20 mt-[7vh] max-w-[82rem]">
          ...
          <m.div style={reduceMotion ? undefined : { y: stageY, scale: stageScale }} className="absolute right-[2%] top-[43%] z-10 h-[43vh] min-h-[19rem] w-[69%] max-sm:right-[-10%] max-sm:top-[46%] max-sm:h-[36vh] max-sm:w-[94%]">
            ...
            <div className="scene-float-delayed absolute right-0 top-0 z-20 border border-black/15 bg-[#efeee8] px-4 py-3 text-black sm:px-5 sm:py-4">
          ...
          <div className="relative z-30 mt-auto grid items-end gap-6 sm:grid-cols-[auto_1fr_minmax(18rem,31rem)]">
